...
namespace ego_planner
{
  ...
  private:
    ...
    Eigen::Vector3d checkSafetyPoint(const Eigen::Vector3d &pt, int inf_step_H, int inf_step_V);
    void checkEnablePath(const Eigen::Vector3d &start, const Eigen::Vector3d &end);
